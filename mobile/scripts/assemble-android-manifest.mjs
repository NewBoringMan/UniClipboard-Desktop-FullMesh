...
// The per-ABI and universal APKs are all independently installable. The AAB is
// a store upload artifact and intentionally does not enter the in-app updater.
const ABIS = ['armeabi-v7a', 'arm64-v8a', 'x86_64', 'universal'];
