...
| -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Android  | Download the matching APK from [GitHub Releases](https://github.com/UniClipboard/UniClip/releases/latest) (`armeabi-v7a`, `arm64-v8a`, `x86_64`, or `universal`) |
