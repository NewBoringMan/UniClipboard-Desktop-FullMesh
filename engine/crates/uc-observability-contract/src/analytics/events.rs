...
impl PairingFailureReason {
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::PreviousJoinCannotBeSuperseded => "previous_join_cannot_be_superseded",
            Self::SponsorRejectedInvitation => "sponsor_rejected_invitation",
            Self::SponsorAdmissionConflict => "sponsor_admission_conflict",
...
mod tests {
    ...
    fn enum_variants_serialize_to_documented_strings() {
        ...
        assert_eq!(
            serde_json::to_value(TransportType::Mailbox).unwrap(),
            "mailbox"
        );
        assert_eq!(
