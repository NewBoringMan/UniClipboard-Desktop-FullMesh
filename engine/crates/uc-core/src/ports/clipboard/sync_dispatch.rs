...
use crate::clipboard::ClipboardEventEnvelope;
...
pub struct ClipboardHeader {
    ...
    /// FullMesh v4/v5 event contract. Legacy v1-v3 frames decode with
    /// `None` and continue through the content-hash compatibility path.
    pub event: Option<ClipboardEventEnvelope>,
}
