...
pub struct CaptureClipboardUseCase {
    ...
    coordinator: Option<Arc<crate::clipboard::entry_identity::EntryIdentityCoordinator>>,
...
impl CaptureClipboardUseCase {
    ...
    pub fn with_entry_identity_coordinator(
        mut self,
        coordinator: Arc<crate::clipboard::entry_identity::EntryIdentityCoordinator>,
    ) -> Self {
    ...
    pub(crate) async fn execute_directory_with_origin(
        ...
        preset_event_id: Option<EventId>,
    ) -> Result<Option<CaptureOutcome>> {
        self.execute_with_origin_internal(
            snapshot,
            origin,
    ...
    async fn execute_with_origin_internal(
        ...
        async move {
            ...
            let event_id = preset_event_id.unwrap_or_else(EventId::new);
